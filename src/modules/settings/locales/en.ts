export default {
  settings: {
    ...
    screens: {
      ...
      detectedTitle: 'Detected screens',
      permissionHint: 'Permission granted, but only this screen was detected. Make sure all monitors are connected and visible.',
      unsupportedHint: 'Your browser does not support automatic monitor detection. Use mirror mode or connect additional monitors manually.',
      detectedHint: 'Screens detected via Window Management API. Use "Identify" to see numbers on each monitor.',
      monitorN: 'Monitor {n}',
      primary: 'Primary',
      detect: 'Detect screens',
      detecting: 'Detecting…',
