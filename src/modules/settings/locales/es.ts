export default {
  settings: {
    ...
    screens: {
      ...
      routeTv: 'Solo escenario (TV/monitor)',
      ...
      detectedTitle: 'Pantallas detectadas',
      permissionHint: 'Permiso concedido, pero solo se detectó esta pantalla. Asegúrate de que todos los monitores estén conectados y visibles.',
      unsupportedHint: 'Tu navegador no soporta la detección automática de monitores. Usa el modo espejo o conecta monitores adicionales manualmente.',
      detectedHint: 'Pantallas detectadas vía Window Management API. Usa "Identificar" para ver números en cada monitor.',
      monitorN: 'Monitor {n}',
      primary: 'Principal',
      detect: 'Detectar pantallas',
    ...
    stage: {
      ...
      bibleTransformUppercase: 'MAYÚSCULAS',
      bibleTransformCapitalize: 'Capitalizado',
