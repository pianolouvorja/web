export default {
  settings: {
    ...
    stage: {
      ...
      bibleTextTransform: 'Capitalização (Bíblia)',
      bibleTransformNone: 'Normal',
      bibleTransformUppercase: 'MAIÚSCULAS',
    ...
    palco: {
      ...
      receiversPlain: 'Monitores receiver',
      receiverCodeLabel: 'Código da sessão — abra no monitor receiver',
      receiverConnected: 'Monitor receiver conectado',
      assignReceiverMonitor: 'Associar receiver a monitor detectado',
      assignedMonitor: 'Associado a: {monitor}',
      tv: 'TV',
      tvHowTo: 'Conecte uma TV com o receiver LouvorJA na mesma rede.',
