...
<template>
  <button
    type="button"
    class="random-project-fab"
    :class="{ 'random-project-fab--active': projecting }"
    :aria-label="projecting ? t('random.clearProjection') : t('random.project')"
    :title="projecting ? t('random.clearProjection') : t('random.project')"
