...
<template>
  <button
    type="button"
    class="timer-project-fab"
    :class="{ 'timer-project-fab--active': projecting }"
    :aria-label="projecting ? t('timer.clearProjection') : t('timer.project')"
    :title="projecting ? t('timer.clearProjection') : t('timer.project')"
